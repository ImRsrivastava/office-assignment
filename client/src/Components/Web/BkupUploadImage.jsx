...
const UploadImage = () => {
    ...
    const handleFormSubmit = async () => {
        setValidateErr('');  setErrorLog('');  setSuccessLog('');
        console.log('check-chosenImage:: ', chosenImage);

        if((!createFormData.category) || (!chosenImage) || (!createFormData.keywords)) {
            if(!chosenImage) { setValidateErr({image: '* Image should not be blank.'}); }
